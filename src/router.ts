...
const routes = [
  ...
  { path: '/task/:id/advances', name: 'AdvanceList', component: () => import('./views/AdvanceList.vue') },
  { path: '/task/:id/advances/new', name: 'AdvanceNew', component: () => import('./views/AdvanceNew.vue') },
];
